		...
		<TooltipPrimitive.Root disableHoverableContent={props.disableHoverableContent}>
			...
			<TooltipPrimitive.Portal>
				<TooltipPrimitive.Content
					...
					className={clsx(
						'TooltipContent z-[101] m-2 mt-1 flex max-w-[200px] select-none items-center gap-2 break-words rounded border border-app-line bg-app-box px-2 py-1 text-center text-xs text-ink',
